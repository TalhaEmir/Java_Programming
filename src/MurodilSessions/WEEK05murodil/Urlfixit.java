    ...
    public static void main(String[] args) {
       ...
       /* Url [Scanner, String methods, conditional]
        ...
        www. in the beginning
                ...
                */
/*
        String url="www.etsy.edu";

        if(url.startsWith("www.") && (url.endsWith(".com")|| url.endsWith(".org")|| url.endsWith(".edu") // url.endsWith(".gov") )){
            String domain= url.substring(4,url.length()-4);


            System.out.println((url + " is valid " + domain));
        ...
        if(!url.endsWith(".com")||! url.endsWith(".org")||! url.endsWith(".edu")){
            System.out.println("your last section is missing");
        }
