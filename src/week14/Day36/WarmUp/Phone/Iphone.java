...
public class Iphone extends Phone {// iphone is a phone relationship is created with extedns
    ...
    public Iphone(String model, String size, int price, String color){// brand of all the iphone is apple
       super(model,size,price,color);// why we deleted brand at the constructor and put the brand name at the super part
